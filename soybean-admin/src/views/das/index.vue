...
const EditComponent = defineAsyncComponent(() => import('./modules/edit/index.vue'));
const FavoriteComponent = defineAsyncComponent(() => import('./modules/favorite/index.vue'));
const HistoryComponent = defineAsyncComponent(() => import('./modules/history/index.vue'));
</script>
